...
% ---
\titulo{Teleoperação de braço robótico por rastreamento de movimentos e imersão visual}
...
\begin{document}
	...
	% Introdução
	% ----------------------------------------------------------
	\include{arm-introducao}
	% ----------------------------------------------------------
	% ----------------------------------------------------------
	% ----------------------------------------------------------
	% Introdução
	% ----------------------------------------------------------
	\include{arm-especificacao}
	% ----------------------------------------------------------
	% ----------------------------------------------------------
	...
	% Metodologia
	% ----------------------------------------------------------
	\include{arm-metodologia}
	% ----------------------------------------------------------
 
	% ----------------------------------------------------------
	% Execução
	% ----------------------------------------------------------
	\include{arm-execucao}
	% ----------------------------------------------------------
